...
import com.g47.cem.cemspareparts.util.JwtUtil;
...
/**
 * JWT Authentication Filter for Spare Parts Service.
 */
@Component
@Slf4j
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path.contains("/swagger-ui") || path.contains("/api-docs") || path.contains("/actuator/health");
    }
} 