-- Re-apply status CHECK constraints to include REJECTED
-- This migration supersedes any previous constraints left by removed migrations
...
-- service_request_history.status
DO $$
BEGIN
    IF EXISTS (
        SELECT 1
